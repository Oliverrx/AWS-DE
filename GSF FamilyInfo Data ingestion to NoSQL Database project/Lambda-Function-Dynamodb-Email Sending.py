...
def send_email(table_name, region, action, data):
    body_html = """\
    <html>
      <head><h1>Database Schema Change Detected in {region}</h1></head>
      <body>
            <br>
            <br>
            <h2>For DynamoDB Table {tablename}</h2><br>
            <br>
        </p><h2>There is a {action} update. </h2><br>
            <br>
            <h3>The change is {data}. </h3><br><br>
        </p>
      </body>
    </html>
